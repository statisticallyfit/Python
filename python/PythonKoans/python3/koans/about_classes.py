...
class AboutClasses(Koan):
    ...
    def test_instances_of_classes_can_be_created_adding_parentheses(self):
        ...
        # into a string value.
        fido = self.Dog()
        self.assertEqual(AttributeError, fido.__class__.__name__)   #todo: DONE

    def test_classes_have_docstrings(self):
        self.assertRegexpMatches(self.Dog.__doc__, )  ##todo:
    ...
    def test_init_method_is_the_constructor(self):
        dog = self.Dog2()
        self.assertEqual('Paul', dog._name) #TODO:DONE

    def test_private_attributes_are_not_really_private(self):
        dog = self.Dog2()
        dog.set_name("Fido")
        self.assertEqual("Fido", dog._name)   #todo: DONE ??
    ...
    def test_you_can_also_access_the_value_out_using_getattr_and_dict(self):
        ...
        self.assertEqual("Fido", getattr(fido, "_name"))   #todo: DONE
        # getattr(), setattr() and delattr() are a way of accessing attributes
        # by method rather than through assignment operators

        self.assertEqual("Fido", fido.__dict__["_name"])   #todo: DONE   ---- why does this work???
    ...
    def test_that_name_can_be_read_as_a_property(self):
        ...
        # access as method
        self.assertEqual("Fido", fido.get_name()) #todo: DONE

        # access as property
        self.assertEqual("Fido", "Fido", fido.name)  #this works even with one "Fido"...?  #todo: DONE
    ...
    def test_creating_properties_with_decorators_is_slightly_easier(self):
        ...
        fido.name = "Fido"
        self.assertEqual("Fido", fido.name) #todo: DONE
    ...
    def test_different_objects_have_different_instance_variables(self):
        ...
        self.assertEqual(False, rover.name == fido.name)  #todo: DONE
